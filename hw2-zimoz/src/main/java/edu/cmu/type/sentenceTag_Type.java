...
public class sentenceTag_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("sentenceTag");
  ...
  public String getID(int addr) {
      ...
      jcas.throwFeatMissing("ID", "sentenceTag");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("Text", "sentenceTag");
